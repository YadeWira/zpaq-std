/// libdivsufsort-lite 2.0 (C) Yuta Mori 2003-2008 -- extraido de zpaq-std.cpp.
///
/// Terceros, autocontenido: sus unicas dependencias del host son el allocator
/// (franz_malloc/franz_free) y myprintf para un mensaje de error. Todo lo demas
/// (ALPHABET_SIZE, SS_BLOCKSIZE, SS_INSERTIONSORT_THRESHOLD) se define aca.
///
/// Vive en namespace divsuf, no en libzpaq: es una libreria de terceros que el
/// formato USA, no parte del formato. Estaba metido en medio del bloque de
/// libzpaq, lo que impedia separar ese bloque (ver el comentario de
/// INLINE_blake3 en zpaq-std.cpp).
...
/// hooks del host
extern void *franz_malloc(size_t i_size);
extern void  franz_free(void *i_mem);
