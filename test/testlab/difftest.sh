...
METHODS="${METHODS:--m1 -m2 -m3 -m5 -ma:zstd -ma:flzma2 -ma:ppmd -ma:bsc -ma:brotli -ma:lz4 -ma:bzip2 -ma:snappy -ma:lzfse -ma:deflate -ma:lzav -ma:bzip3 -ma:lz5 -ma:lz6 -ma:lzma -ma:lz -store}"
