/*
  ...
  levels 10-29 (fastLZ4 and LIZv1; levels 30-49 add Huffman and stay
  non-portable). zpaq-std, 2026. Generated by gen.py next to this file (ZPAQL
  has no subroutines: the stream reads and copies are macros expanded in place).
